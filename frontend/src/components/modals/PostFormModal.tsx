...
const PostFormModal: React.FC<PostFormModalProps> = React.forwardRef(
  ({ initialData, onClose, onSubmit, type, isOpen, isLoading }, ref) => {
    ...
    return (
      <Modal open={isOpen} onClose={onClose}>
        <Box ref={ref} sx={styles.formContainer}>
          {isLoading ? (
            <Loader />
          ) : (
